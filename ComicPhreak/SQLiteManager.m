		...
		for (int i = 0; i<columns; i++) {
			...
			switch (type) {
				case SQLITE_INTEGER:
				{
					...
					//NSLog(@"returning int for column %@", columnName);
					break;
				}
				case SQLITE_FLOAT:
				{
				...
				case SQLITE_TEXT:
				{
					...
					//NSLog(@"returning text for column %@", columnName);
					break;
				}
                    
				case SQLITE_BLOB:
				{
					// I guess no blob implementation
					break;
				}
				...
				case SQLITE_NULL:
				{
					...
					//NSLog(@"returning [NSNull null] for column %@", columnName);
					break;
				}
				...
				default:
				{
					const char *value = (const char *)sqlite3_column_text(statement, i);
					[result setObject:[NSString stringWithCString:value encoding:NSUTF8StringEncoding] forKey:columnName];
					//NSLog(@"returning ??? for column %@", columnName);
					break;
				}
